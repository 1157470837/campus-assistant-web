...
public class TestInsertDatabases {
	...
	public static void init() {
		...
		intentService = (IIntentService)factory.getBean("intentService");
	}
	...
	public void testInsert() {
		try {
			...
			intentService.addIntentsFromInputStream(this.getClass().getClassLoader()
					.getResourceAsStream("intentInfo.txt"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
